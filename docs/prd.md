...
**Do roadmap Fase 1 ainda faltando:** imagem de capa, tempo estimado de leitura, posts relacionados. Slug único (`docs/features/002-post-slug/`), paginação (`docs/features/003-post-pagination/`), `enum PostStatus` (`docs/features/004-post-status/`) e tags/categorias (`docs/features/005-tags-categorias/`) já implementados.
